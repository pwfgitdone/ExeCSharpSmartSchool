...
namespace SmartSchool_WebAPI.Data
{
    public class Repository : IRepository
    {
        ...
        public async Task<Aluno[]> GetAllAlunosByProfessorAsync(int professorId, bool includeDisciplina = false)
        {
            ...
            query = query.AsNoTracking()
                         .OrderBy(c => c.Id)
                         .Where(l => l.AlunosDisciplinas.Any(k => k.Disciplina.ProfessorId == professorId) );
        ...
        public async Task<Disciplina[]> GetAllDisciplinasAsync(bool includeProfessores = true)
        {
        ...
        public async Task<Disciplina> GetDisciplinaAsyncById(int disciplinaId, bool includeProfessores = true)
        {
            IQueryable<Disciplina> query = _context.Disciplinas;
        ...
        public async Task<AlunoDisciplina[]> GetAllMatriculasAsync()
        {
            IQueryable<AlunoDisciplina> query = _context.AlunosDisciplinas;

            query = query.Include(a => a.Aluno);
        ...
        public async Task<AlunoDisciplina> GetMatriculaAsyncByAlunoIdDisciplinaId(int alunoId, int disciplinaId)
        {
            IQueryable<AlunoDisciplina> query = _context.AlunosDisciplinas;

            query = query.AsNoTracking()
                         .OrderBy(matricula => matricula.AlunoId)
                         .Where(matricula => (matricula.AlunoId == alunoId) && (matricula.DisciplinaId == disciplinaId));
